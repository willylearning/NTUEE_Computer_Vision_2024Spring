...
if __name__ == '__main__':
    ...
    dst = np.zeros((h, w, c))
    H3_1 = solve_homography(corners1, ref_corns)
    output3_1 = warping(secret1, dst, H3_1, 0, w, 0, h, direction='b')
    
    dst = np.zeros((h, w, c))
    H3_2 = solve_homography(corners2, ref_corns)
    output3_2 = warping(secret2, dst, H3_2, 0, w, 0, h, direction='b') 
