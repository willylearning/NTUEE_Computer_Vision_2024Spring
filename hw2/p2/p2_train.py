...
def plot_learning_curve(logfile_dir, result_lists):
    ...
    # is not fixed.                                                #
    ################################################################
    x = range(1, len(result_lists['train_acc'])+1) # epoch
    # 1. training accuracy
    plt.plot(x, result_lists['train_acc'])
    plt.xlabel('epoch')
    plt.ylabel('acc')
    ...
    plt.close()
    # 2. training loss  
    plt.plot(x, result_lists['train_loss'])
    plt.xlabel('epoch')
    plt.ylabel('loss')
    ...
    plt.close()
    # 3. validation accuracy  
    plt.plot(x, result_lists['val_acc'])
    plt.xlabel('epoch')
    plt.ylabel('acc')
    ...
    plt.close()
    # 4. validation loss 
    plt.plot(x, result_lists['val_loss'])
    plt.xlabel('epoch')
    plt.ylabel('loss')
